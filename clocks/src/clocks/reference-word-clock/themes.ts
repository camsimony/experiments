...
export const REFERENCE_CLOCK_THEME_PRESETS = [
  ...
  {
    name: 'Slate',
    pageBg: 'oklch(0.255 0.012 255)',
    wordColor: 'oklch(0.795 0.02 255)',
    hourHandColor: 'oklch(0.91 0.012 255)',
    minuteHandColor: 'oklch(0.62 0.018 255)',
    secondHandColor: 'oklch(0.74 0.09 55)',
    centerPinColor: 'oklch(0.74 0.09 55)',
  },
  {
    name: 'Kelp',
    pageBg: 'oklch(0.25 0.035 183)',
    wordColor: 'oklch(0.78 0.06 170)',
    hourHandColor: 'oklch(0.89 0.038 162)',
    minuteHandColor: 'oklch(0.61 0.045 176)',
    secondHandColor: 'oklch(0.75 0.105 92)',
    centerPinColor: 'oklch(0.75 0.105 92)',
  },
  {
    name: 'Cinder',
    pageBg: 'oklch(0.255 0.044 28)',
    wordColor: 'oklch(0.795 0.058 41)',
    hourHandColor: 'oklch(0.9 0.038 48)',
    minuteHandColor: 'oklch(0.62 0.048 32)',
    secondHandColor: 'oklch(0.68 0.14 18)',
    centerPinColor: 'oklch(0.68 0.14 18)',
  },
  {
    name: 'Orchid',
    pageBg: 'oklch(0.898 0.038 322)',
    wordColor: 'oklch(0.46 0.092 331)',
    hourHandColor: 'oklch(0.25 0.04 330)',
    minuteHandColor: 'oklch(0.55 0.06 326)',
    secondHandColor: 'oklch(0.58 0.12 190)',
    centerPinColor: 'oklch(0.58 0.12 190)',
  },
  {
    name: 'Tobacco',
    pageBg: 'oklch(0.36 0.066 73)',
    wordColor: 'oklch(0.82 0.09 87)',
    hourHandColor: 'oklch(0.92 0.05 88)',
    minuteHandColor: 'oklch(0.66 0.062 78)',
    secondHandColor: 'oklch(0.72 0.13 32)',
    centerPinColor: 'oklch(0.72 0.13 32)',
  },
